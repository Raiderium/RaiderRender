 ...
 * Electronic tapestry.
 * 
 * A straight wrapper around an RGBA 32bpp GL texture.
 */
class Texture
{private:
	uint _width;
...
public:
	 ...
	 * 
	 * Don't bother using this. It's called automatically when appropriate.*/
	void release()
	{
		/*"glDeleteTextures silently ignores 0's and names that
		do not correspond to existing textures." - Our friend the OpenGL reference */
